...
@Composable
fun UploadCalendarDateSelectionScreen(
    ...
    val months = remember { (0..2).map { currentMonth.plusMonths(it.toLong()) } }
...
@Preview
@Composable
private fun UploadCalendarDateSelectionScreenPreview() {
    WitTheme {
